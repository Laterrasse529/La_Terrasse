...
const SHEET_CSV_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQQf7Y2ksewOerFgAW4JWGV3wYUK9ubS9f38ybQI94FOWzv_XllgHDQ1nW3eXIRQ0sdwWhg-izrSKqU/pub?output=csv"; 
...
const DEFAULT_MENU = [
  {
    ...
    items: [
      { name: "Petit Déjeuner : Du Jour", desc: "Café au choix - Eau (0.5L) - Jus au choix (Citron / Fraise) - Cake ou Croissant", price: "11.000 DT" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Pâte Rouge Carbonara (Fraîche)", desc: "Pâtes fraîches à la sauce tomate façon carbonara", price: "19.000 DT" },
      { name: "Pâte Rouge Bolognaise (Fraîche)", desc: "Pâtes fraîches à la sauce bolognaise maison", price: "19.000 DT" },
      ...
      { name: "Pasta Bolognaise (Classique)", desc: "Pâtes classiques à la sauce bolognaise", price: "19.000 DT" },
      { name: "Pasta Carbonara (Classique)", desc: "Pâtes classiques à la crème et fromage", price: "19.000 DT" },
  ...
  },
  {
    ...
    items: [
      { name: "Escalope Grillée", desc: "Escalope de poulet grillée servie avec garniture", price: "18.000 DT" },
      { name: "Escalope Panée", desc: "Escalope de poulet croustillante", price: "20.000 DT" },
      ...
      { name: "Côtelette d'Agneau", desc: "Côtelettes d'agneau tendres et grillées", price: "45.000 DT" },
      { name: "mixte Grillée", desc: "Un généreux assortiment de grillades sélectionnées", price: "42.000 DT" },
      ...
      { name: "Ojja Fruits de Mer", desc: "Ojja riche aux fruits de mer", price: "27.000 DT" }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
       { name: "Jwajem L", desc: "Dessert traditionnel - Taille M", price: "9.000 DT" },
       { name: "Jwajem M", desc: "Dessert traditionnel aux fruits et fruits secs - Taille L", price: "13.000 DT" },
  ...
  },
  {
    ...
    items: [
      { name: "Jus Citron Classique", desc: "Citronnade fraîche maison", price: "5.500 DT" },
      { name: "Jus Orange", desc: "Orange fraîche pressée", price: "7.000 DT" },
      { name: "Jus Citron Menthe", desc: "Citronnade mixée à la menthe fraîche", price: "6.500 DT" },
  ...
  },
  {
    ...
    items: [
      { name: "Mojito Classique", desc: "Citron vert, menthe fraîche, eau gazeuse, sirop", price: "7.000 DT" },
      { name: "Mojito Un Choix", desc: "Mojito aromatisé avec un parfum au choix", price: "9.000 DT" },
      { name: "Smoothie Kiwi", desc: "Kiwi frais mixé", price: "10.000 DT" },
      { name: "Smoothie Fraise", desc: "Fraises mixées veloutées", price: "9.500 DT" },
